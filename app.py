...
sample_events=[
    {
        "printername":"HP PrintScan",
        "printermodel": "RP 2302",
        "building":"Research",
        "floor":"3",
        "department": "science",
	"room": "5"
...
class EventModel(db.Model):
    ...
    printername = db.Column('PRINTERNAME',db.String(255))
    printermodel = db.Column('PRINTERMODEL',db.String(255))
    building = db.Column('BUILDING', db.String(255))
    floor = db.Column('FLOOR', db.String(255))
    department = db.Column('DEPARTMENT',db.String(255))
    room = db.Column('ROOM',db.String(255))
...
class EventInSchema(Schema):
    printername = String(required=True, validate=Length(0, 255))
    printermodel = String(required=True, validate=Length(0, 255))
    building = String(required=True, validate=Length(0, 255))
    floor = String(required=True, validate=Length(0, 255))
    department = String(required=True, validate=Length(0, 255))
    room = String(required=True, validate=Length(0, 255))
...
def get_event_name(short_name):
    ...
    return EventModel.query.filter(EventModel.printername.like(search)).first()
